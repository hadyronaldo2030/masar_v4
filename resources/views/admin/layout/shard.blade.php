            ...
            <div class="boxheadSide">
                <div class="d-flex flex-column">
                    ...
                    <a href="{{ route('home') }}" class='logoaside'>
                        ...
                        <img src="{{ asset($globalVariable . 'assets') }}/img/M-.png" class="d-none" style="width: 30px;"/>
                    </a>
                    <!-- user Aside -->
                    <div class="useraside">
                        <div class="boxuser">
                    ...
                    <section>
                        <span class="openSlide btnGray d-none">
                            <i class="fa-solid fa-users fa-xl px-3"></i>
                        </span>
                        <!-- Droplist-->
                        <button class="btn btnGray" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                        ...
                        <div class="collapse" id="collapseOne">
                            <div class="card card-body">
                                @can('isAdmin')
                                <a href="{{ url('/admin/hr/dashboard') }}">Dashboard</a>
                                <a href="{{ url('admin/hr/empList') }}">Employees List</a>
                                <a href="{{ url('admin/hr/create') }}">Add Employees</a>
                                <a href="{{ url('admin/hr/dataEntry') }}">Data Entry</a>
                                @elsecan('isHr')
                                <a href="{{ url('/admin/hr/dashboard') }}">Dashboard</a>
                                <a href="{{ url('admin/hr/empList') }}">Employees List</a>
                                <a href="{{ url('admin/hr/create') }}">Add Employees</a>
                                ...
                                <a href="{{ url('admin/hr/dataEntry') }}">Data Entry</a>
                                @elsecan('isEmployee' )
                                    @if (Auth::user()->can('isEmployee') && Auth::user()->department == "programming")
                                    <a href="{{ route('projects.programming.showProject') }}">Tasks</a>
                                    @elseif (Auth::user()->can('isEmployee') && Auth::user()->department != "programming")
                                        <a href="{{ route('projects.marketing.showProject') }}">Tasks</a>
                                    @endif
                                @endcan
                            </div>
                        </div>
