                    ...
                    <div class="tab-pane fade show active" id="dayInventory" role="tabpanel"
                        ...
                        <section class="sectionCard mx-3">
                            @foreach ($revenuesData as $revenue )
                                <div class="boxCards monthlyContracts-content show-all category-content">
                                    <div class="front">
                                        <!-- {{-- Line --}} -->
                                        ...
                                        <div class="contentCard">
                                            <!-- {{-- Number Cards --}} -->
                                            <span class="numCard rotateCard monthlyContracts">{{ $revenue->id }}</span>
                                            <!-- {{-- service Type --}} -->
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="edit btn-success mx-2">
                                                        <a class="bg-none text-success" 
                                                            data-bs-toggle="modal"
                                                            data-id="{{ $revenue->id }}" 
                                                            data-name="{{ $revenue->name }}"
                                                            data-amount="{{ $revenue->amount }}" 
                                                            data-notes="{{ $revenue->notes }}"
                                                            data-contract_type="{{ $revenue->contract_type }}"
                                                            data-due_date="{{ $revenue->due_date }}"
                                                            data-start_date="{{ $revenue->start_date }}"
                                                            data-images="{{ json_encode($revenue->images) }}"
                                                            data-bs-target="#exampleModalBasicEdit">
                    ...
                    <div class="tab-pane fade" id="tabTow" role="tabpanel" aria-labelledby="tabTow-tab">
                        ...
                        <div class="d-flex justify-content-between m-3">
                            ...
                            <button class="addItem" data-bs-toggle="modal" data-bs-target="#exampleModalPety"><i
                                    class="fa-solid fa-plus"></i>213</button>
                        </div>
                        {{-- Cards pety cach --}}
                        <section class="sectionCard mx-3">
                                ...
                                <div class="front">
                                    ...
                                    <div class="contentCard">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="edit btn-success mx-2">
                                                <button class="bg-none text-success" data-bs-toggle="modal">
                                                    <i class="fa-regular fa-pen-to-square"></i>
                                                </button>
                                            </div>
                                            {{--               Update Status                  --}}
                    ...
                    <div class="col mb-3">
                        <div class="input-group uploadImg">
                            <span class="minImg">
                                ...
                                <input type="file" id="file-upload0" name="images[]" class="file-upload">
                                <img src="" alt="">
                        ...
                        <div class="boxMinImg">
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload1" class="file-upload">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload2" class="file-upload" onchange="previewImage(event, 2)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload3" class="file-upload" onchange="previewImage(event, 3)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload4" class="file-upload" onchange="previewImage(event, 4)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload5" class="file-upload" onchange="previewImage(event, 5)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload6" class="file-upload" onchange="previewImage(event, 6)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload7" class="file-upload" onchange="previewImage(event, 7)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload8" class="file-upload" onchange="previewImage(event, 8)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload9" class="file-upload" onchange="previewImage(event, 9)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <span class="minImg">
                                ...
                                <input type="file" name="images[]" id="file-upload10" class="file-upload" onchange="previewImage(event, 10)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                        </div>
...
{{-- ===============================================Start Modal Edit========================================================= --}}
    ...
    <form class="modal fade" id="exampleModalBasicEdit" tabindex="-1" aria-labelledby="exampleModalLabel" action="" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="modal-dialog">
            <div class="modal-content popupWindow">
                ...
                <div class="modal-body row">
                    <div class="col-7 mb-3">
                        ...
                        <div class="input-group mb-3 justify-content-end">
                            <input type="number" class="form-control" placeholder="Type Value" id="amount" name="amount" step="any" aria-label="Dollar amount (with dot and two decimal places)">
                            <span class="text-warning position-absolute my-1 mx-2">EGP</span>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="date" class="form-control" placeholder="End" id="due_date" name="due_date"
                                aria-describedby="addon-wrapping">
                        </div>
                    ...
                    <div class="col mb-3">
                        <div class="input-group uploadImg">
                            <span class="minImg">
                                ...
                                <input type="file" id="file-upload11 images" class="file-upload">
                                <img  id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                        </div>
                        {{-- small Images --}}
                        <div class="boxMinImg" id="editImagesContainer">
                            <!-- Card 1 -->
                            <span class="minImg">
                                <label for="file-upload12" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload12 images" class="file-upload" name="images[]">
                                <img  id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 2 -->
                            <span class="minImg">
                                <label for="file-upload13" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload13 images" class="file-upload" onchange="previewImage(event, 2)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 3 -->
                            <span class="minImg">
                                <label for="file-upload14" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload14 images" class="file-upload" onchange="previewImage(event, 3)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 4 -->
                            <span class="minImg">
                                <label for="file-upload15" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload15 images" class="file-upload" onchange="previewImage(event, 4)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 5 -->
                            <span class="minImg">
                                <label for="file-upload16" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload16 images" class="file-upload" onchange="previewImage(event, 5)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 6 -->
                            <span class="minImg">
                                <label for="file-upload17" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload17 images" class="file-upload" onchange="previewImage(event, 6)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 7 -->
                            <span class="minImg">
                                <label for="file-upload18" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload18 images" class="file-upload" onchange="previewImage(event, 7)">
                                <img   src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>

                            <!-- Card 8 -->
                            <span class="minImg">
                                <label for="file-upload19" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload19 images" class="file-upload" onchange="previewImage(event, 8)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 9 -->
                            <span class="minImg">
                                <label for="file-upload20" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload20 images" class="file-upload" onchange="previewImage(event, 9)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 10 -->
                            <span class="minImg">
                                <label for="file-upload21" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" name="images[]" id="file-upload21 images" class="file-upload" onchange="previewImage(event, 10)">
                                <img   id="my_image" src="{{ asset($globalVariable . 'images/revenue/' . $image->images) }}" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                        </div>
                    ...
                    <div class="input-group">
                        <textarea class="form-control" placeholder="Type Notes" id="notes" name="notes" aria-label="With textarea"></textarea>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
{{-- ====================================================== Start Pety Cash================================================================ --}}
    ...
    {{-- Popup Window Editing pety cach --}}
    <form class="modal fade" id="EditModalPety" tabindex="-1" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog">
            <div class="modal-content popupWindow">
                {{-- Nav Popup --}}
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Pety Cach</h5>
                    <button type="button" class="btn-close closepopup" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body row">
                    <div class="col-7 mb-3">
                        ...
                        <div class="input-group mb-4">
                            <input type="date" class="form-control" id="start_date" placeholder="Start"
                                aria-describedby="addon-wrapping">
                        </div>
                        <div class="input-group mb-4">
                            <input type="date" class="form-control" placeholder="End" id="due_date"
                                aria-describedby="addon-wrapping">
                        </div>

                        {{-- Select Type --}}
                        <div class="input-group ">
                            <select class="form-select" id="search-category contract_type"
                                aria-label="Default select example">
                                <option selected disabled>Type </option>
                                <option value="reservedService">Reserved Service</option>
                                <option value="weeklyContracts">Weekly Contracts</option>
                    ...
                    <div class="col mb-3">
                        <div class="input-group uploadImg">
                            <span class="minImg">
                                <label for="file-upload33" class="custom-upload-button">Upload Image</label>
                                <input type="file" id="file-upload33" class="file-upload">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                        </div>
                        ...
                        <div class="boxMinImg">
                            <!-- Card 1 -->
                            <span class="minImg">
                                <label for="file-upload34" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload34" class="file-upload">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 2 -->
                            <span class="minImg">
                                <label for="file-upload35" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload35" class="file-upload" onchange="previewImage(event, 2)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 3 -->
                            <span class="minImg">
                                <label for="file-upload36" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload36" class="file-upload" onchange="previewImage(event, 3)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 4 -->
                            <span class="minImg">
                                <label for="file-upload37" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload37" class="file-upload" onchange="previewImage(event, 4)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 5 -->
                            <span class="minImg">
                                <label for="file-upload38" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload38" class="file-upload" onchange="previewImage(event, 5)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 6 -->
                            <span class="minImg">
                                <label for="file-upload39" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload39" class="file-upload" onchange="previewImage(event, 6)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 7 -->
                            <span class="minImg">
                                <label for="file-upload40" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload40" class="file-upload" onchange="previewImage(event, 7)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 8 -->
                            <span class="minImg">
                                <label for="file-upload41" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload41" class="file-upload" onchange="previewImage(event, 8)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 9 -->
                            <span class="minImg">
                                <label for="file-upload42" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload42" class="file-upload" onchange="previewImage(event, 9)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                            ...
                            <!-- Card 10 -->
                            <span class="minImg">
                                <label for="file-upload43" class="custom-upload-button"><i class="fa-solid fa-plus pos"></i></label>
                                <input type="file" id="file-upload43" class="file-upload" onchange="previewImage(event, 10)">
                                <img src="" alt="">
                                <div class="delete-button"><i class="fa-solid fa-x fa-sm"></i></div>
                            </span>
                        </div>
                    ...
                    <div class="input-group">
                        <textarea class="form-control" placeholder="Type Notes" id="notes" aria-label="With textarea"></textarea>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
{{-- ====================================================== Start Pety Cash================================================================ --}}
    ...
    {{-- popup img  --}}
    <div id="overlay">
        <div class="w-100 h-100 d-flex justify-content-center flex-column-reverse">
            <img id="overlay-image" src="" alt="Overlay Image">
            <a id="download-button" href="#" download>download img</a>
        </div>
    </div>
    <!-- Alert Notes -->
