        ...
        <div class="titleSection">
            ...
            <div class="d-flex">
                <select class="mx-3 btn btnGray" id="contract-type">
                    <option value="all" selected>All debartment</option>
                    <option value="programming">Programming</option>
                    <option value="marketing">Marketing</option>
                </select>
                <a href="{{ route('manager.createtasks') }}" class=" btn btnGray">Create Task</a>
            </div>
        </div>
        <div class="row">
            <div id="employeToggle" class="col h-100">
                ...
                <div class="viewBar mb-3">
                    ...
                    <div class="col boxBar department">
                        <div class="d-flex justify-content-center align-items-center">
                            <span class="px-2">
                                <h1 class="activeToggle" data-type="all">3</h1>
                                <h1 class="activeToggle" data-type="programming">1</h1>
                                <h1 class="activeToggle" data-type="marketing">2</h1>
                            </span>
                            <span class="d-flex flex-column w-100">
