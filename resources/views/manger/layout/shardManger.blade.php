...
<head>
    ...
    <!--  Style css -->
    <link href="{{ asset($globalVariable . 'assetsManeger') }}/css/sharedManeger.css" rel="stylesheet">
    @yield('style')
</head>
                    ...
                    <section>
                        ...
                        <div class="collapse" id="collapseOne">
                            <div class="card card-body">
                                @can('isAdmin')
                                <a href="{{ url('client/manager/dashbord') }}">Dashboard Manager</a>
                                <a href="{{ route('projects.marketing.showProject') }}">Project Marketing</a>
                                <a href="{{ route('manager.marketing.createtasks') }}">Create Task Marketing</a>
                                <a href="{{ route('projects.programming.showProject') }}">Project Programming</a>
                                <a href="{{ route('manager.programming.createtasks') }}">Create Task Programming</a>
                                ...
                                @if(Auth::user()->can('isManager') && Auth::user()->department == 'programming')
                                <a href="{{ route('projects.programming.showProject') }}">Project Programming</a>
                                <a href="{{ url('client/manager/dashbord') }}">Dashboard Manager</a>
                                <a href="{{ route('manager.programming.createtasks') }}">Create Task Programming</a>
                                @endif
